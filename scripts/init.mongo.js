...
const initialTutors = [
  ...
  {
    username: '1', gender:'F', courseType: ['CS', 'ST'], 
    courses: ['CS3443', 'IT5002', 'ST5300'], price: [30, 50], 
    availability: ['1-15', '3-17', '5-19'], 
    level:'M', degree: 'Master of Science in Statistics',
    completedLessons: 50, numReviews: 2, stars: 4.5, 
    intro: 'I love tutoring and I am also a big fan of computer science. The thought of combining these two together makes me so excited, and I am happy to help other students in CS.'
  }
]

const initialReviews = [
  { date: '20201220', tutorName: 'PKV', studentName: 'A0242694X', stars: 5, content: 'Wonderful tutor who gives so many feedbacks on my progress.' },
  { date: '20200805', tutorName: 'PKV', studentName: 'A0242720R', stars: 5, content: 'Wonderful tutor who gives so many feedbacks on my progress.' },
  { date: '20201221', tutorName: '1', studentName: 'A0242694X', stars: 4, content: 'Wonderful tutor in general, hope could be more on-time.' },
  { date: '20201220', tutorName: '1', studentName: 'A0242720R', stars: 5, content: 'Wonderful tutor who gives so many feedbacks on my progress.' },
]
